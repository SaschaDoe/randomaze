...
export let PlanetChineseAdjectives = [
    ...
    { output: '令人惊叹的', transliteration: 'lìngrén jīngtàn', english: 'Breathtaking' },
    ...
    { output: '振奋人心的', transliteration: 'zhènfèn rénxīn', english: 'Inspiring' },
    { output: '令人惊异的', transliteration: 'lìngrén jīngyì', english: 'Astounding' },
